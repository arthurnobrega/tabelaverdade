...
public class TabelaVerdade {
    ...
    /** Cria uma nova inst�ncia de Tabela Verdade.
     */
    ...
    /** Preenche as colunas das proposi��es com V ou F.
     */
    ...
    /** Resolve de fato a tabela, preenchendo com V ou F a �ltima coluna, que � o resultado.
     *
     */
    ...
    /** Realiza a opera��o de acordo com o respectivo conectivo.
     */
    ...
    /* Retorna o valor da da proposi��o em determinada linha (V ou F).
     * @param proposicao O nome da proposi��o que se deseja pegar o valor.
    ...
    /** Retorna as linhas que ser�o mostradas na tabela.
     */
    public ArrayList<String[]> getLinhas() {
        return (ArrayList<String[]>) linhas.clone();
    }
    
    /** Retorna as colunas que ser�o mostradas na tabela.
     */
